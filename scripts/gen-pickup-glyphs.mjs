...
const LETTERS = ['Q', 'R', 'S'];
const FONT_SIZE = 160;
// Font Awesome 6 solid — shield (U+F132)
const SHIELD_CODEPOINT = 0xf132;
...
// Shield: public/game/fonts/fa-solid-900.ttf (FA Free / CC BY 4.0)
